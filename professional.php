      ...
      <div class="container" >
        <div class="row no-gutters" style="width: 1000px; margin-left: 9%; ">
          ...
          <div class="col-lg-8 px-5 pt-2">
            ...
            <h1 class="font-weight-bold" style="text-align: center; font-family: serif; font-weight: bold;">Mental Health Professional</h1><br>
            ...
            <form action="logincheck.php" method="POST">
              ...
              <div class="form-row">
                <div class="col-lg-10" style="margin-left: 34%">
                  <h6>Position</h6>
                  <input type="Position" class="form-control my-3 p-3" placeholder="Position" name="Position" >
                </div>
              </div>
              <div class="form-row">
                <div class="col-lg-10" style="margin-left: 34%">
                ...
                <div class="form-row">
                <div class="col-lg-10" style="margin-left: 34%">
                  <h6>Work Expreience</h6>
                  <input type="Expreience" class="form-control my-3 p-3" placeholder="Work Expreience" name="Expreience" >
                </div>
                <div class="form-row">
                <div class="col-lg-10"style="margin-left: 34%">
                  <h6>Certification</h6>
                  <input type="Certification" class="form-control my-3 p-3" placeholder="Certification" name="Certification" >
                </div>
              </div>
              <div class="form-row">
                <div class="col-lg-10"style="margin-left: 34%">
