      ...
      <div class="container" >
        <div class="row no-gutters" style="width: 1000px; margin-left: 9%; ">
          ...
          <div class="col-lg-8 px-5 pt-2">
            ...
            <h1 class="font-weight-bold" style="text-align: center; font-family: serif; font-weight: bold;">Guardian of Patient</h1><br>
            ...
            <form action="logincheck.php" method="POST">
              ...
              <div class="form-row">
                <div class="col-lg-10" style="margin-left: 34%">
                  <h6>Name</h6>
                  <input type="Name" class="form-control my-3 p-3" placeholder="Name" name="name" >
                </div>
              </div>
              <div class="form-row">
                <div class="col-lg-10" style="margin-left: 34%">
                ...
                <div class="form-row">
                <div class="col-lg-10" style="margin-left: 34%">
                  <h6>Relation with Patient</h6>
                  <input type="Relation" class="form-control my-3 p-3" placeholder="Relation with Patient" name="Relation" >
                </div>
